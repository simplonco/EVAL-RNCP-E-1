...
if(isset($_POST['submit'])){
        $rf=$_POST["rf"];
            ...
            echo "Entrer le numéro de référence";
        }
   /*
   ...
   */
   ...
   $tbl_name="comment";     //your table name
   ...
   */
   ...
   $targetpage = "control.php";    //your file name  (the name of this file)
   ...
   /* Get data. */
   $sql = "SELECT * FROM comment where reference='$rf'";
...
?>
<h1 class='title'>TABLEAU DE COMMENTAIRES</h1>
<form action="#" method="post">
    <div class="control-group">
  <label class="control-label" for="textinput-1">Article Referance</label>
  <div class="controls">
    <input id="textinput-1" name="rf" type="text" placeholder="referance" class="email">
  </div>
</div>
<!-- Button -->
<p>
...
if ($_POST['delete']) {
    foreach($_POST['checkbox'] as $selected){
      $sql2="DELETE FROM comment WHERE id='$selected'";
      $query2=mysqli_query($connect,$sql2);
    }

    if($query2){
      
      echo "<meta http-equiv='refresh' content='0;url=control.php?id=".$id."'>";
    }
  }
